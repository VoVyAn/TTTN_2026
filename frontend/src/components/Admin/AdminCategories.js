...
function AdminCategories() {
  ...
  const [formData, setFormData] = useState({ name: '', lang: 'VN', sortOrder: 0, isHidden: false });
  ...
  const handleOpenModal = (item = null) => {
    if (item) {
      ...
      setIsEdit(false);
      setCurrentId(null);
      setFormData({ name: '', lang: 'VN', sortOrder: 0, isHidden: false });
    }
    setShowModal(true);
  };
      ...
      <div className="admin-table-wrapper">
        <table className="admin-table">
          ...
          <tbody>
            ...
            {categories.length === 0 && (
              <tr>
                <td colSpan="5" style={{ textAlign: 'center' }}>Chưa có danh mục nào</td>
              </tr>
            )}
          </tbody>
        </table>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="admin-form-group">
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                  ...
                  />
                  <label htmlFor="isHidden" style={{ margin: 0, fontWeight: 'normal' }}>Ẩn danh mục này</label>
                </div>
              </div>
