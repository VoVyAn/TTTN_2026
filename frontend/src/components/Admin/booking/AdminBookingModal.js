...
function AdminBookingModal({
  ...
  const isCompleted = editingRes.status === 'completed';
    ...
    <div className="bk-modal-overlay">
      <div className="bk-modal-content">
        ...
        <div className="bk-modal-grid">
          <div className="bk-form-group" style={{ position: 'relative' }}>
            ...
            <input
              ...
              disabled={isCompleted || (adminRole === 'user' && !editingRes.isNew)}
              style={isCompleted || (adminRole === 'user' && !editingRes.isNew) ? { opacity: 0.6, cursor: 'not-allowed' } : {}}
            />
          ...
          <div className="bk-form-group">
            ...
            <input 
              ...
              disabled={isCompleted || (adminRole === 'user' && (!editingRes.isNew || editingRes.isAutoFilled))}
              style={isCompleted || (adminRole === 'user' && (!editingRes.isNew || editingRes.isAutoFilled)) ? { opacity: 0.6, cursor: 'not-allowed' } : {}}
            />
          </div>
          <div className="bk-form-group">
            <label>Email</label>
          ...
          <div className="bk-form-group">
            <label>Guests</label>
            <input type="number" min="1" value={editingRes.guests || ''} onChange={(e) => handleEditChange('guests', e.target.value)} disabled={isCompleted} />
          </div>
          <div className="bk-form-group">
            <label>Date</label>
            <input type="date" value={editingRes.date || ''} onChange={(e) => handleEditChange('date', e.target.value)} disabled={isCompleted} />
          </div>
          <div className="bk-form-group">
            <label>Time</label>
            <input type="time" value={editingRes.time || ''} onChange={(e) => handleEditChange('time', e.target.value)} disabled={isCompleted} />
          </div>
          <div className="bk-form-group">
            <label>Nationality</label>
            <input type="text" value={editingRes.nationality || ''} onChange={(e) => handleEditChange('nationality', e.target.value)} disabled={isCompleted} />
          </div>
          <div className="bk-form-group">
            <label>Channel</label>
            <select value={editingRes.channel || 'Website'} onChange={(e) => handleEditChange('channel', e.target.value)} disabled={isCompleted}>
          ...
          <div className="bk-form-group">
            <label>Creator</label>
            <input type="text" value={editingRes.creator || ''} onChange={(e) => handleEditChange('creator', e.target.value)} disabled={isCompleted} />
          </div>

          <div className="bk-form-group">
            <label>Table</label>
            <select value={editingRes.table || ''} onChange={(e) => handleEditChange('table', e.target.value)} disabled={isCompleted}>
        ...
        <div className="bk-form-group full-width">
          <label>Note</label>
          <textarea value={editingRes.note || ''} onChange={(e) => handleEditChange('note', e.target.value)} rows="3" disabled={isCompleted} />
        </div>
